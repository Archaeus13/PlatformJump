...
class Hero(Sprite):
    ...
    def __init__(self, filename: str):
        ...
        # 初始化位置【测试用】
        self.shape.rect.center = (50, 500) #地面高度550；主角尺寸50,50
...
# 竖直方向基础运动
    ...
    def jump(self):
        '''跳跃'''
        print("jump")
        if not self.is_jumping:  # 用来限制二段跳（我们要允许二段跳吗？）
